...
it("core-autofit-large-font", async () => {
  const rawBoard: Board = JSON.parse(
    readFileSync(
      path.join(__dirname, "./boards/core-autofit-large-font.obf")
    ).toString()
  );
  ...
  const source = readFileSync(
    path.join(__dirname, "./screenshots/core-autofit-large-font.1.png")
  );
  const result = readFileSync(
    path.join(__dirname, "./temp/core-autofit-large-font.1.png")
  );
...
it("portrait-with-branding", async () => {
  const rawBoard: Board = JSON.parse(
    readFileSync(
      path.join(__dirname, "./boards/portrait-with-branding.obf")
    ).toString()
  );
  ...
  const source = readFileSync(
    path.join(__dirname, "./screenshots/portrait-with-branding.1.png")
  );
  const result = readFileSync(
    path.join(__dirname, "./temp/portrait-with-branding.1.png")
  );
