...
const initialTiles: Array<Tile> = [
  ...
  { key: "tea", label: "tea", isCore: false },
  { key: "milk", label: "milk", isCore: false },
  { key: "biscuit", label: "biscuit", isCore: false },
  { key: "sugar", label: "sugar", isCore: false },
  { key: "tea-party", label: "tea party", isCore: false },
  { key: "cup", label: "cup", isCore: false },
  { key: "plate", label: "plate", isCore: false },
  { key: "eat", label: "eat", isCore: false },
