...
const generateSymbolPreset = (
  ...
  return tiles.map((tile) => ({
    id: tile.key,
    value: tile.showBlank ? `/blank.png` : `./symbols/${name}/${tile.key}.png`,
  }));
};
...
const generateImageVariables = (
  ...
  return tiles.map((tile) => ({
    ...
    hidden: true,
    defaultValue: tile.showBlank
      ? `/blank.png`
      : `./symbols/${name}/${tile.key}.png`,
  }));
};
...
export const turnTaking: Template = {
  ...
  A symbol chart to support communication around turn taking. 
    `,
  templateName: "Turn Taking",
  templateId: "turn-taking-launchpad",
  templateImageUrl: "turn-taking.png",
