  ...
  pages: [
    {
      ...
      grid: {
        ...
        columns: 6,
        order: [
          ["me", "more", "look", "question", "colour", "make-up"],
          ["you", "stop", "want", "this", "eye-shadow", "mascara"],
          ["go", "different", "help", "put-on", "brush-hair", "foundation"],
          ["like", "great", "omg", "take-off", "hair-clip", "blusher"],
          ["wow", "uh-oh", "nail-varnish", "no", "mirror", "lipstick"],
        ],
      },
    },
  ],
