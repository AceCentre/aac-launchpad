...
export const colours: Template = {
  templateDateCreated: "2022-07-20T12:00:00+01:00",
  templateCategory: "Symbol Charts",
  templateSubcategory: "Symbol charts with core vocabulary",
  templateFeatured: false,
  templateShortDescription:
    "A symbol chart to support communication about colour. It could be used during an arts and crafts activities, while playing games, choosing what clothes to wear … the possibilities are endless!",
  ...
  templateId: "colours-launchpad",
  templateImageUrl: "colours.png",
