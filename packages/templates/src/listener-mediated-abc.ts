...
export const listenerMediatedAbc: Template = {
  templateFeatured: false,
  templateCategory: "Listener Mediated",
  templateSubcategory: "Listener Mediated",
  templateShortDescription:
    "Create a listener mediated chart with ABC letter arrangement",
  ...
  templateVariables: [
    ...
    {
      id: "emptySpaceBackgroundColor",
      description: "Pick the background colour for empty spaces on the chart",
      type: "color",
    ...
    {
      id: "font-size",
      description: "Set the font size for the labels on the chart",
      name: "Font Size",
      type: "number",
      defaultValue: "31",
      min: 8,
  ...
  templateVariableGroups: [
    {
      id: "advanced-options",
      variables: ["gap", "row-gap", "command-casing", "border-width"],
      name: "More options",
  ...
  templateId: "listener-mediated-abc-launchpad",
  templateDateCreated: "2022-07-20T12:00:00+01:00",
  templateDescription:
    "Create a listener mediated chart with ABC letter arrangement",
  templateName: "Listener Mediated ABC Template",
  templateImageUrl: "listener-mediated1.png",

  format: "open-board-0.1",
  id: "listener-mediated-abc-launchpad",
  locale: "en-GB",
  name: "Listener Mediated ABC Template",
  description_html: "Listener Mediated ABC board",
