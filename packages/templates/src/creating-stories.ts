...
export const creatingStories: Template = {
  ...
  A symbol chart to support communication around creating a story.
    `,
  templateName: "Creating Stories",
  templateId: "creating-stories-launchpad",
  templateImageUrl: "creating-stories.png",
  ...
  pages: [
    {
      ...
      grid: {
        ...
        columns: 6,
        order: [
          ["me", "more", "look", "question", "girl", "boy"],
          ["you", "stop", "want", "this", "cat", "monster"],
          ["go", "different", "help", "find", "city", "home"],
          ["like", "funny", "scary", "run", "school", "forest"],
          ["wow", "uh-oh", "naughty", "no", "magic-wand", "treasure"],
        ],
      },
    },
  ],
